...
{
  class TestContactItemWrapper : TestComWrapperBase<TestContactItemWrapper>, IContactItemWrapper
  {
    private readonly IContactItemWrapper _inner;
    ...
    protected override TestContactItemWrapper This()
    {
      return this;
    }

    public ContactItem Inner => _inner.Inner;
