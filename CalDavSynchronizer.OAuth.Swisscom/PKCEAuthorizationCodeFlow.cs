...
namespace CalDavSynchronizer.OAuth.Swisscom
{
    ...
    /// </para>
    /// </summary>
    public class PKCEAuthorizationCodeFlow : IAuthorizationCodeFlow
    {
        ...
        public class Initializer
        {
            ...
            /// </summary>
            internal Initializer(PKCEAuthorizationCodeFlow flow)
            {
        ...
        public string CodeVerifier { get { return codeVerifier; } }

        public string CodeChallenge { get { return codeChallenge; } }
        ...
        public PKCEAuthorizationCodeFlow(Initializer initializer)
        {
            ...
            codeVerifier = initializer.CodeVerifier;
            codeChallenge = initializer.CodeChallenge;
        ...
        public virtual AuthorizationCodeRequestUrl CreateAuthorizationCodeRequest(string redirectUri)
        {
            ...
            return new PKCEAuthorizationCodeRequestUrl(new Uri(AuthorizationServerUrl))
            {
