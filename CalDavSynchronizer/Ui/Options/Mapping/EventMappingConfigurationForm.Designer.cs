...
namespace CalDavSynchronizer.Ui.Options.Mapping
{
  partial class EventMappingConfigurationForm
  {
    ...
    private void InitializeComponent ()
    {
      ...
      this._calendarColorSetButton.Click += new System.EventHandler(this.CalendarColorSetButton_Click);
      // 
      ...
      this._calendarColorRefreshButton.Click += new System.EventHandler(this.CalendarColorRefreshButton_Click);
      // 
      // _mapColorCheckBox
      // 
