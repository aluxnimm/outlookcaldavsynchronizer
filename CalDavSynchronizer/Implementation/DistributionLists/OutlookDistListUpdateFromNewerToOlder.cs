...
namespace CalDavSynchronizer.Implementation.DistributionLists
{
  internal class OutlookDistListUpdateFromNewerToOlder
    : UpdateFromNewerToOlder<string, DateTime, GenericComObjectWrapper<DistListItem>, WebResourceName, string, vCard, DistributionListSychronizationContext>
  {
    private static readonly ILog s_logger = LogManager.GetLogger (System.Reflection.MethodInfo.GetCurrentMethod ().DeclaringType);

    public OutlookDistListUpdateFromNewerToOlder (
      EntitySyncStateEnvironment<string, DateTime, GenericComObjectWrapper<DistListItem>, WebResourceName, string, vCard, DistributionListSychronizationContext> environment,
