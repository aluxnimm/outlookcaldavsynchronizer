...
namespace CalDavSynchronizer.Implementation.GoogleContacts
{
    class GoogleApiOperationExecutor : IGoogleApiOperationExecutor
    {
        ...
        readonly PeopleServiceService _contactFacade;
        ...
        public GoogleApiOperationExecutor(PeopleServiceService contactFacade)
        {
        ...
        public T Execute<T>(Func<PeopleServiceService, T> operation)
        {
        ...
        public void Execute(Action<PeopleServiceService> operation)
        {
            Execute(f =>
            {
                operation(f);
