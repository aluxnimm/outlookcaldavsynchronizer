...
namespace CalDavSynchronizer.Implementation.Events
{
  internal class OutlookCaldavEventUpdateFromNewerToOlder
      : UpdateFromNewerToOlder<AppointmentId, DateTime, AppointmentItemWrapper, WebResourceName, string, IICalendar>
  {
    public OutlookCaldavEventUpdateFromNewerToOlder (EntitySyncStateEnvironment<AppointmentId, DateTime, AppointmentItemWrapper, WebResourceName, string, IICalendar> environment, IEntityRelationData<AppointmentId, DateTime, WebResourceName, string> knownData, DateTime newA, string newB)
