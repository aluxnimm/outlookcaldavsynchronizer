...
namespace GenSync.EntityRepositories
{
  ...
  {
    Task<IReadOnlyList<EntityIdWithVersion<TEntityId, TEntityVersion>>> GetVersions (ICollection<TEntityId> ids);
    Task<IReadOnlyList<EntityIdWithVersion<TEntityId, TEntityVersion>>> GetVersions ();
