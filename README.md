...
When adding a new profile you can choose between a generic CalDAV/CardDAV, a google profile to simplify the google profile creation and predefined CalDAV/CardDAV profiles for SOGo, Fruux, Posteo, Yandex, GMX, mail.de, Sarenet and Landmarks, Cozy Cloud and Nextcloud where the DAV Url for autodiscovery is already entered. 
